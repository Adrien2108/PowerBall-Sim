...
def calc_win_amt(my_numbers, winning_num):
    win_amt = 0

    white_matches = len(my_numbers["whites"].intersection(winning_num["whites"]))
    power_match = my_numbers["red"] == winning_num["red"]
...
for drawing in range(num_drawings):
    ...
    winning_num = {"whites": white_drawing, "red": red_drawing}
